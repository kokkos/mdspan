...
struct type_at;
template <size_t, class Seq, class = std::make_index_sequence<Seq::size>>
struct type_at_large_impl;
...
struct type_at_large_impl<I, type_list<Ts...>,
                          std::integer_sequence<size_t, Idxs...>>
    : decltype(MDSPAN_IMPL_FOLD_ASSIGN_LEFT(
          type_at_assign_op_impl{},
          /* = ... = */ type_at_entry<I, Idxs, Ts>{})) {};

template <size_t I, class... Ts>
struct type_at<I, type_list<Ts...>> : type_at_large_impl<I, type_list<Ts...>> {
};
