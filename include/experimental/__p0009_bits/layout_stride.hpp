...
struct layout_stride {
  ...
  public:
    ...
    static_assert(detail::__is_extents_v<Extents>, MDSPAN_PP_STRINGIFY(MDSPAN_IMPL_STANDARD_NAMESPACE) "::layout_stride::mapping must be instantiated with a specialization of " MDSPAN_PP_STRINGIFY(MDSPAN_IMPL_STANDARD_NAMESPACE) "::extents.");
