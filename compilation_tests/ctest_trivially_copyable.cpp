...
MDSPAN_STATIC_TEST(
    std::is_trivially_copyable<Kokkos::extents<size_t, Kokkos::dynamic_extent,
...
MDSPAN_STATIC_TEST(
    std::is_trivially_copyable<Kokkos::extents<size_t, 1, 2, 3>>::value);

MDSPAN_STATIC_TEST(
    std::is_trivially_copyable<Kokkos::extents<size_t, 42>>::value);
...
MDSPAN_STATIC_TEST(
    std::is_trivially_copyable<Kokkos::layout_left::template mapping<
        Kokkos::extents<size_t, 42, Kokkos::dynamic_extent, 73>>>::value);

MDSPAN_STATIC_TEST(
    std::is_trivially_copyable<Kokkos::layout_right::template mapping<
        Kokkos::extents<size_t, 42, Kokkos::dynamic_extent, 73>>>::value);
...
MDSPAN_STATIC_TEST(
    std::is_trivially_copyable<Kokkos::layout_stride::template mapping<
        Kokkos::extents<size_t, 42, Kokkos::dynamic_extent, 73>>>::value);
...
MDSPAN_STATIC_TEST(std::is_trivially_copyable<
                   layout_stride_as_member_should_be_standard_layout>::value);
#endif
...
MDSPAN_STATIC_TEST(
    std::is_trivially_copyable<Kokkos::mdspan<
        double,
        Kokkos::extents<size_t, Kokkos::dynamic_extent, Kokkos::dynamic_extent>,
        Kokkos::layout_left, Kokkos::default_accessor<double>>>::value);
