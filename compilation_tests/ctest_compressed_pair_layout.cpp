...
template <class T, size_t Size, emptyness Empty = non_empty,
...
//==============================================================================
// <editor-fold desc="compressed pair layout: 1 nested pair, 3 leaf element">
// {{{1
#if defined(MDSPAN_IMPL_USE_ATTRIBUTE_NO_UNIQUE_ADDRESS)
  test<CP<E0, CP<E0, E0>>, 3,
       empty>();  // Emulation can't handle this correctly.
#endif
#ifdef MDSPAN_IMPL_COMPILER_MSVC
...
//==============================================================================
// <editor-fold desc="compressed pair layout: 2 nested pairs, 4 leaf element">
// {{{1
#if defined(MDSPAN_IMPL_USE_ATTRIBUTE_NO_UNIQUE_ADDRESS)
  test<CP<CP<E0, E0>, CP<E0, E0>>, 4,
       empty>();  // Emulation can't handle this correctly.
#endif
#ifdef MDSPAN_IMPL_COMPILER_MSVC
  ...
  // </editor-fold> end compressed pair layout: 2 nested pairs, 4 leaf elements
  // }}}1
  //==============================================================================
}
