...
void BM_Raw_Stencil_3D_right(benchmark::State& state, T, SizeX x, SizeY y,
                             SizeZ z) {
...
BENCHMARK_CAPTURE(BM_Raw_Stencil_3D_right, size_80_80_80, int(), size_t(80),
                  size_t(80), size_t(80));
BENCHMARK_CAPTURE(BM_Raw_Stencil_3D_right, size_400_400_400, int(), size_t(400),
                  size_t(400), size_t(400));
