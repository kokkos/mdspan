...
constexpr void test_mdspan_types(const H& handle, const M& map, const A& acc) {
  ...
  static_assert(std::is_trivially_move_constructible_v<MDS> ==
                (std::is_trivially_move_constructible_v<H> &&
                 std::is_trivially_move_constructible_v<M> &&
...
constexpr void mixin_layout(const H& handle, const A& acc) {
  ...
  static_assert(
      !std::is_trivially_move_constructible_v<typename layout_wrapping_integral<
...
constexpr void mixin_accessor() {
  ...
  static_assert(
      std::is_trivially_move_constructible_v<std::default_accessor<T>>);
