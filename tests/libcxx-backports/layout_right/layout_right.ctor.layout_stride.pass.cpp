...
constexpr void test_rank_mismatch() {
  ...
  static_assert(
      !std::is_constructible_v<lr_mapping_t<int, D>, ls_mapping_t<int>>);
  static_assert(
      !std::is_constructible_v<lr_mapping_t<int>, ls_mapping_t<int, D, D>>);
  static_assert(
      !std::is_constructible_v<lr_mapping_t<int, D>, ls_mapping_t<int, D, D>>);
...
constexpr void test_static_extent_mismatch() {
  ...
  static_assert(!std::is_constructible_v<lr_mapping_t<int, D, 5>,
                                         ls_mapping_t<int, D, 4>>);
  static_assert(
      !std::is_constructible_v<lr_mapping_t<int, 5>, ls_mapping_t<int, 4>>);
  static_assert(!std::is_constructible_v<lr_mapping_t<int, 5, D>,
