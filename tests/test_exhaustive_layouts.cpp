...
struct TestLayout<
    std::tuple<Mapping, std::integer_sequence<size_t, DynamicSizes...>>>
    : public ::testing::Test {
  Mapping map;

  void initialize_mapping() {
    using extents_type =
        std::remove_cv_t<std::remove_reference_t<decltype(map.extents())>>;
...
using test_3d_left_types =
    std::tuple<typename Kokkos::layout_left::template mapping<Extents>,
               std::integer_sequence<size_t, DynamicSizes...>>;

template <class Extents, size_t... DynamicSizes>
using test_3d_right_types =
    std::tuple<typename Kokkos::layout_right::template mapping<Extents>,
               std::integer_sequence<size_t, DynamicSizes...>>;

using layout_test_types_3d = ::testing::Types<
    ...
    for (size_t j = 0; j < this->map.extents().extent(1); ++j) {
      for (size_t k = 0; k < this->map.extents().extent(2); ++k) {
        EXPECT_EQ(this->map(i, j, k), this->expected_mapping(i, j, k))
            ...
            << " with extents " << this->map.extents().extent(0) << ", "
...
template <class Layout1, class Layout2, class Extents1, class Extents2,
          bool Implicit, size_t... AllSizes>
...
using layout_conversion_test_types_left_to_left = ::testing::Types<
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_left,
                           Kokkos::extents<size_t, dyn>,
                           Kokkos::extents<size_t, 5>, true, 5>,
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_left,
                           Kokkos::extents<size_t>, Kokkos::extents<size_t>,
                           true>,
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_left,
                           Kokkos::extents<size_t, 5>,
                           Kokkos::extents<size_t, dyn>, false, 5>,
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_left,
                           Kokkos::extents<size_t, dyn, dyn>,
                           Kokkos::extents<size_t, 5, 10>, true, 5, 10>,
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_left,
                           Kokkos::extents<size_t, dyn, dyn>,
                           Kokkos::extents<size_t, 5, dyn>, true, 5,
                           0>  // intentional 0 here to test degenerated
    ,
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_left,
                           Kokkos::extents<size_t, dyn, 10>,
                           Kokkos::extents<size_t, 5, 10>, true, 5, 10>,
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_left,
                           Kokkos::extents<size_t, 5, dyn>,
                           Kokkos::extents<size_t, 5, 10>, true, 5, 10>,
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_left,
                           Kokkos::extents<size_t, 5, dyn>,
                           Kokkos::extents<size_t, 5, dyn>, true, 5, 10>,
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_left,
                           Kokkos::extents<size_t, dyn, 10, 15, dyn, 25>,
                           Kokkos::extents<size_t, 5, 10, dyn, 20, dyn>, false,
                           5, 10, 15, 20, 25>,
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_left,
                           Kokkos::extents<size_t, 5, 10, 15, 20, 25>,
                           Kokkos::extents<size_t, 5, 10, dyn, 20, dyn>, false,
                           5, 10, 15, 20, 25>,
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_left,
                           Kokkos::extents<size_t, dyn, dyn, dyn, dyn, dyn>,
                           Kokkos::extents<size_t, 5, 10, dyn, 20, dyn>, true,
                           5, 10, 15, 20, 25>,
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_left,
                           Kokkos::extents<size_t, 5, 10, 15, 20, 25>,
                           Kokkos::extents<size_t, 5, 10, 15, 20, 25>, true, 5,
                           10, 15, 20, 25>>;

// Right <=> Right conversion
using layout_conversion_test_types_right_to_right = ::testing::Types<
    test_layout_conversion<Kokkos::layout_right, Kokkos::layout_right,
                           Kokkos::extents<size_t, dyn>,
                           Kokkos::extents<size_t, 5>, true, 5>,
    test_layout_conversion<Kokkos::layout_right, Kokkos::layout_right,
                           Kokkos::extents<size_t>, Kokkos::extents<size_t>,
...
using layout_conversion_test_types_stride_to_stride = ::testing::Types<
    test_layout_conversion<Kokkos::layout_stride, Kokkos::layout_stride,
                           Kokkos::extents<size_t, dyn>,
                           Kokkos::extents<size_t, 5>, true, 5>,
    test_layout_conversion<Kokkos::layout_stride, Kokkos::layout_stride,
                           Kokkos::extents<size_t>, Kokkos::extents<size_t>,
...
using layout_conversion_test_types_right_to_stride = ::testing::Types<
    test_layout_conversion<Kokkos::layout_stride, Kokkos::layout_right,
                           Kokkos::extents<size_t, dyn>,
                           Kokkos::extents<size_t, 5>, true, 5>,
    test_layout_conversion<Kokkos::layout_stride, Kokkos::layout_right,
                           Kokkos::extents<size_t>, Kokkos::extents<size_t>,
...
using layout_conversion_test_types_left_to_stride = ::testing::Types<
    test_layout_conversion<Kokkos::layout_stride, Kokkos::layout_left,
                           Kokkos::extents<size_t, dyn>,
                           Kokkos::extents<size_t, 5>, true, 5>,
    test_layout_conversion<Kokkos::layout_stride, Kokkos::layout_left,
                           Kokkos::extents<size_t>, Kokkos::extents<size_t>,
...
using layout_conversion_test_types_stride_to_left = ::testing::Types<
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_stride,
                           Kokkos::extents<size_t, dyn>,
                           Kokkos::extents<size_t, 5>, false, 5>,
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_stride,
                           Kokkos::extents<size_t>, Kokkos::extents<size_t>,
                           true>,
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_stride,
    ...
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_stride,
                           Kokkos::extents<size_t, dyn, dyn>,
                           Kokkos::extents<size_t, 5, 10>, false, 5, 10>,
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_stride,
                           Kokkos::extents<size_t, dyn, dyn>,
                           Kokkos::extents<size_t, 5, dyn>, false, 5,
                           0>  // intentional 0 to test degenerate
    ,
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_stride,
                           Kokkos::extents<size_t, dyn, 10>,
    ...
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_stride,
                           Kokkos::extents<size_t, 5, dyn>,
                           Kokkos::extents<size_t, 5, dyn>, false, 5, 10>,
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_stride,
                           Kokkos::extents<size_t, dyn, 10, 15, dyn, 25>,
                           Kokkos::extents<size_t, 5, 10, dyn, 20, dyn>, false,
                           5, 10, 15, 20, 25>,
    ...
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_stride,
                           Kokkos::extents<size_t, 5, 10, 15, 20, 25>,
                           Kokkos::extents<size_t, 5, 10, 15, 20, 25>, false, 5,
                           10, 15, 20, 25>>;

// Stride => Right conversion
using layout_conversion_test_types_stride_to_right = ::testing::Types<
    test_layout_conversion<Kokkos::layout_right, Kokkos::layout_stride,
                           Kokkos::extents<size_t, dyn>,
                           Kokkos::extents<size_t, 5>, false, 5>,
    test_layout_conversion<Kokkos::layout_right, Kokkos::layout_stride,
                           Kokkos::extents<size_t>, Kokkos::extents<size_t>,
...
using layout_conversion_test_types_left_to_right = ::testing::Types<
    test_layout_conversion<Kokkos::layout_right, Kokkos::layout_left,
                           Kokkos::extents<size_t, dyn>,
                           Kokkos::extents<size_t, 5>, true, 5>,
    test_layout_conversion<Kokkos::layout_right, Kokkos::layout_left,
                           Kokkos::extents<size_t, 5>,
                           Kokkos::extents<size_t, dyn>, false, 5>,
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_right,
                           Kokkos::extents<size_t, dyn>,
                           Kokkos::extents<size_t, 5>, true, 5>,
    test_layout_conversion<Kokkos::layout_left, Kokkos::layout_right,
                           Kokkos::extents<size_t, 5>,
...
struct TestLayoutConversion<
  ...
  create_map2(Extents exts) {
    return map_2_t(
        typename Kokkos::layout_left::template mapping<Extents>(exts));
  }
...
TYPED_TEST_SUITE(TestLayoutConversion,
                 layout_conversion_test_types_left_to_left);

template <class T>
using TestLayoutConversion_R2R = TestLayoutConversion<T>;
TYPED_TEST_SUITE(TestLayoutConversion_R2R,
                 layout_conversion_test_types_right_to_right);

template <class T>
using TestLayoutConversion_S2S = TestLayoutConversion<T>;
TYPED_TEST_SUITE(TestLayoutConversion_S2S,
                 layout_conversion_test_types_stride_to_stride);
...
TYPED_TEST_SUITE(TestLayoutConversion_L2S,
                 layout_conversion_test_types_left_to_stride);

template <class T>
using TestLayoutConversion_S2L = TestLayoutConversion<T>;
TYPED_TEST_SUITE(TestLayoutConversion_S2L,
                 layout_conversion_test_types_stride_to_left);

template <class T>
using TestLayoutConversion_S2R = TestLayoutConversion<T>;
TYPED_TEST_SUITE(TestLayoutConversion_S2R,
                 layout_conversion_test_types_stride_to_right);

template <class T>
using TestLayoutConversion_L2R = TestLayoutConversion<T>;
TYPED_TEST_SUITE(TestLayoutConversion_L2R,
                 layout_conversion_test_types_left_to_right);
...
TYPED_TEST(TestLayoutConversion, implicit_conversion) {
  ...
  static_assert(TestFixture::implicit ==
                ((!std::is_same<typename TestFixture::layout_2_t,
                                Kokkos::layout_stride>::value &&
                  std::is_convertible<typename TestFixture::exts_2_t,
                                      typename TestFixture::exts_1_t>::value) ||
                 (std::is_same<typename TestFixture::layout_2_t,
                               Kokkos::layout_stride>::value &&
                  std::is_same<typename TestFixture::layout_1_t,
                               Kokkos::layout_stride>::value &&
                  std::is_convertible<typename TestFixture::exts_2_t,
                                      typename TestFixture::exts_1_t>::value) ||
                 (std::is_same<typename TestFixture::layout_2_t,
  ...
  static_assert(std::is_convertible<typename TestFixture::map_2_t,
                                    typename TestFixture::map_1_t>::value ==
